...
4.1) Para realizar os testes dos cenários, rodar os seguintes comandos:
...
5) Como alguns cenários da API de Clientes lançam erros, não ficam tão legíveis pelo cUrl, portanto, seguem prints das requisições via Postman:
...
6) Além disso, seguem prints da execução dos cenários da API de Contratos:
